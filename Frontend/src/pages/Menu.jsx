      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 relative z-10">
        ...
        <AnimatePresence mode="wait">
          {loading ? (
            ...
            >
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-10 border-b border-white/5 pb-8 animate-pulse">
                  <div className="flex-1 flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-8 w-full">
                    <div className="w-24 h-24 md:w-32 md:h-32 shrink-0 bg-white/5 rounded-md"></div>
                  ...
                  <div className="flex flex-col items-start md:items-end w-full md:w-32 gap-3 mt-4 md:mt-0">
                    <div className="h-6 w-20 bg-white/10 rounded"></div>
                    <div className="h-3 w-16 bg-[#c5a059]/20 rounded mt-2"></div>
                  </div>
                </div>
              ))}
            </motion.div>
