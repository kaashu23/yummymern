    ...
    return (
      <div className="max-w-6xl mx-auto p-6 md:p-12 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[1, 2, 3, 4].map(i => (
            <div key={i} className="bg-[#0a0a0a] p-6 rounded-2xl border border-white/5 animate-pulse">
        ...
        <div className="bg-[#0a0a0a] rounded-2xl border border-white/5 overflow-hidden p-8 animate-pulse">
